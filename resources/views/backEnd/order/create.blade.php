  ...
  <div class="col-lg-12">
   <div class="card">
    ...
    <tr>
        ...
        <th style="width: 10%;">Size</th> <th style="width: 15%;">Quantity</th>
    ...
    @php $product_discount += $value->options->product_discount*$value->qty; Session::put('product_discount',$product_discount); @endphp 
    @endforeach
</tbody>
       </table>
      </div>
      <div class="col-sm-12">
       <div class="form-group mb-3">
        ...
        <select name="source_id" id="source_add" class="form-control select2 @error('source_id') is-invalid @enderror" >
         <option value="">Select..</option>
      ...
      <div class="col-sm-12">
          <div class="form-group mb-3">
              ...
              @if(auth()->user()->user_type == 'admin' || auth()->user()->hasRole('Super Admin'))
                  {{-- এডমিন হলে ড্রপডাউন দেখবে এবং সিলেক্ট করতে পারবে --}}
              ...
              @else
                  {{-- মডারেটর হলে শুধু নিজের নাম দেখবে এবং অটোমেটিক অ্যাসাইন হবে --}}
                  <input type="text" class="form-control" value="{{ auth()->user()->name }}" readonly disabled>
                  <input type="hidden" name="assign_user_id" value="{{ auth()->id() }}">
              @endif
          </div>
      </div>
