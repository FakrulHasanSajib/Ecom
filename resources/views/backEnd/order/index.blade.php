                ...
                <div class="row">
                    <div class="col-sm-8">
                        <ul class="action2-btn">
                            ...
                            @endif
                            <li><a href="{{route('admin.order.order_csv')}}" class="btn rounded-pill btn-info multi_order_csv"><i class="fe-download"></i> CSV</a></li>
                ...
                <table id="datatable-buttons" class="table table-striped   w-100">
                    <thead>
                        <tr>
                          ...
                          <th style="width:10%">Order Source</th>
                    ...
                    <tbody>
                        @foreach($show_data as $key=>$value)
                                 @php
                                    $product = $value->orderdetails->first()->product ?? null;
                                @endphp
                        <tr>
                            ...
                            <td>
                             ...
                             <td> <img src="{{ asset($product->image ? $product->image->image : '') }}" alt="" height="60" width="50"> </td>
