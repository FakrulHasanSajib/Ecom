...
@section('title', 'Create Theme 9 (Video & 4 Images)')
@section('css')
...
<div class="container-fluid">
    <div class="card border-0 shadow-lg mt-3">
        <div class="card-header bg-white">
            <h4 class="text-primary fw-bold">Create Campaign (Theme 9)</h4>
        </div>
        <div class="card-body">
            <form action="{{route('campaign.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="review" value="5">

                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3">
                            <label class="fw-bold">ক্যাম্পেইন টাইটেল (Product Name) *</label>
                            <input type="text" class="form-control" name="name" id="name" required placeholder="Example: প্রিমিয়াম পাঞ্জাবি কালেকশন">
                        </div>
                        <div class="mb-3">
                            <label class="fw-bold">ভিডিও সেকশন (YouTube Video ID) *</label>
                            <input type="text" class="form-control" name="video" placeholder="Ex: eIrRj6vDddU">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="short_description" class="summernote form-control"></textarea>
                        </div>
                        ...
                        <div class="card bg-light border-0 mb-3">
                            ...
                            <div class="card-body" id="testi_container"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="card-body">
                                <div class="mb-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="image_one" id="img1" readonly>
                                        <button type="button" class="btn btn-secondary" onclick="openGallery('img1')">Browse</button>
                                    </div>
                                    <div class="img-preview-box"><img id="view_img1" src=""></div>
                                </div>
                                <div class="mb-2">
                                    <label>Image 2</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="image_two" id="img2" readonly>
                                        <button type="button" class="btn btn-secondary" onclick="openGallery('img2')">Browse</button>
                                    </div>
                                    <div class="img-preview-box"><img id="view_img2" src=""></div>
                                </div>
                                <div class="mb-2">
                                    <label>Image 3</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="image_three" id="img3" readonly>
                                        <button type="button" class="btn btn-secondary" onclick="openGallery('img3')">Browse</button>
                                    </div>
                                    <div class="img-preview-box"><img id="view_img3" src=""></div>
                                </div>
                                <div class="mb-2">
                                    <label>Image 4</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="image_four" id="img4" readonly>
                                        <button type="button" class="btn btn-secondary" onclick="openGallery('img4')">Browse</button>
                                    </div>
                                    <div class="img-preview-box"><img id="view_img4" src=""></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-success w-100 py-2">Publish Campaign</button>
                    </div>
                </div>
            </form>
        </div>
