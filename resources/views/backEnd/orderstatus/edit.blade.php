                ...
                <form action="{{route('orderstatus.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('colorcode') is-invalid @enderror" name="colorcode" value="{{ $edit_data->colorcode}}" id="colorcode" required="" placeholder="#ffffff">
                            @error('colorcode')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
