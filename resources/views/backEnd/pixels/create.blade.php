                ...
                <form action="{{route('pixels.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('meta_access_token') is-invalid @enderror" name="meta_access_token" value="{{ old('meta_access_token') }}" id="meta_access_token">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('ad_account_id') is-invalid @enderror" name="ad_account_id" value="{{ old('ad_account_id') }}" id="ad_account_id" required="">
                            @error('ad_account_id')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
