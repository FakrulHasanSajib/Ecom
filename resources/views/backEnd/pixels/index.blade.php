...
<style>
    /* Ensures that long text in table cells is truncated */
    .table-truncate {
        max-width: 150px; /* Adjust this value as needed for your design */
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
        display: block; /* Important for text-overflow to work correctly in td */
    }
</style>
@endsection
            ...
            <div class="card-body">
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            <th>SL</th>
                            <th style="width: 15%;">Pixels ID</th>
                            <th style="width: 15%;">Ad Account ID</th> <th style="width: 25%;">Meta Access Token</th> <th>Status</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$value->code}}</td>
                            <td>{{$value->ad_account_id}}</td> <td>
                                <span class="table-truncate" title="{{$value->meta_access_token}}">
