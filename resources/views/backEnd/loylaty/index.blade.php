                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    @endif
                                    <a href="{{route('authorinfo.payment',$value->id)}}" title="Payment" class="btn btn-xs btn-primary waves-effect waves-light"> <i class="fas fa-eye"></i>  </a>
