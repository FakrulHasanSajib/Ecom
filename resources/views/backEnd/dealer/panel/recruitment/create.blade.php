        ...
        <div class="col-12">
            <div class="card mt-3">
                <div class="card-header bg-primary">
                    <h5 class="mb-0 text-white">Campaign Details (Dynamic Content)</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('dealer.recruitment.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="title" id="name" class="form-control" placeholder="যেমন: উদ্যোক্তা বা এজেন্ট নিয়োগ" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Slug (URL) *</label>
                                <input type="text" name="slug" id="slug" class="form-control" required placeholder="e.g. agent-recruitment">
                            </div>

                            <div class="col-md-12 mb-3">
                                <label class="form-label fw-bold">Header Main Text (Optional)</label>
                                <textarea name="header_text" class="form-control" rows="2" placeholder="হেডার সেকশনের বড় লেখাটি এখানে দিন..."></textarea>
                            </div>

                            {{-- Video Section --}}
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Agent Video ID (YouTube) *</label>
                                <input type="text" name="agent_video_id" class="form-control" placeholder="Only ID, e.g: dQw4w9WgXcQ">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Khadem Video ID (YouTube) *</label>
                                <input type="text" name="khadem_video_id" class="form-control" placeholder="Only ID, e.g: dQw4w9WgXcQ">
                            </div>

                            {{-- Link Section --}}
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Custom Login URL (Optional)</label>
                                <input type="text" name="login_url" class="form-control" placeholder="Default is /login">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Custom Register URL (Optional)</label>
                                <input type="text" name="register_url" class="form-control" placeholder="Default is /register">
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="file-manager-bar">
                                    <button type="button" class="file-browse-btn" onclick="openGallery('image_one')">
                                        <i class="fa fa-image me-2"></i>Browse
                                    </button>
                                    <span class="file-info-text" id="status_image_one">Empty</span>
                                </div>
                                <div class="gallery-item-card" id="preview_card_image_one">
                                    <button type="button" class="remove-btn-small" onclick="clearImage('image_one')"><i class="fa fa-times"></i></button>
                                    <img src="" id="img_tag_image_one">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="file-manager-bar">
                                    ...
                                    <span class="file-info-text" id="status_image_two">Empty</span>
                                </div>
                                <div class="gallery-item-card" id="preview_card_image_two">
                                    <button type="button" class="remove-btn-small" onclick="clearImage('image_two')"><i class="fa fa-times"></i></button>
                                    <img src="" id="img_tag_image_two">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="file-manager-bar">
                                    ...
                                    <span class="file-info-text" id="status_image_three">Empty</span>
                                </div>
                                <div class="gallery-item-card" id="preview_card_image_three">
                                    <button type="button" class="remove-btn-small" onclick="clearImage('image_three')"><i class="fa fa-times"></i></button>
                                    <img src="" id="img_tag_image_three">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="file-manager-bar">
                                    ...
                                    <span class="file-info-text" id="status_feature_section_image">Empty</span>
                                </div>
                                <div class="gallery-item-card" id="preview_card_feature_section_image">
                                    <button type="button" class="remove-btn-small" onclick="clearImage('feature_section_image')"><i class="fa fa-times"></i></button>
                                    <img src="" id="img_tag_feature_section_image">
                                    <input type="hidden" name="feature_section_image" id="feature_section_image">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card-box-border">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="card_1_title" class="form-control" placeholder="Title here...">
                                        </div>
                                        <div>
                                            <label class="form-label">Description</label>
                                            <textarea name="card_1_desc" class="form-control" rows="2" placeholder="Description here..."></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card-box-border">
                                        ...
                                        <div class="mb-2">
                                            <label class="form-label">Title</label>
                                            <input type="text" name="card_2_title" class="form-control" placeholder="Title here...">
                                        </div>
                                        <div>
                                            <label class="form-label">Description</label>
                                            <textarea name="card_2_desc" class="form-control" rows="2" placeholder="Description here..."></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card-box-border">
                                        ...
                                        <div class="mb-2">
                                            <label class="form-label">Title</label>
                                            <input type="text" name="card_3_title" class="form-control" placeholder="Title here...">
                                        </div>
                                        <div>
                                            <label class="form-label">Description</label>
                                            <textarea name="card_3_desc" class="form-control" rows="2" placeholder="Description here..."></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card-box-border">
                                        ...
                                        <div class="mb-2">
                                            <label class="form-label">Title</label>
                                            <input type="text" name="card_4_title" class="form-control" placeholder="Title here...">
                                        </div>
                                        <div>
                                            <label class="form-label">Description</label>
                                            <textarea name="card_4_desc" class="form-control" rows="2" placeholder="Description here..."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn btn-primary px-5 btn-lg">
                                    <i class="fa fa-save me-1"></i> Save Campaign
                                </button>
                            </div>
                        </div>
                    </form>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            // 🔥 Multi-Image Preview Engine
            // এটি প্রতি ৫০০ms পরপর চেক করবে যে কোনো ইমেজের ইনপুটে ডাটা এসেছে কিনা
