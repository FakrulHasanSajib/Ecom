          ...
          <form action="{{route('products.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data" name="editForm">
            ...
            <div class="col-sm-12 mb-3">
              <div class="form-group">
                <label for="short_dec" class="form-label">Short Description</label>
                <textarea name="short_dec" rows="6" class="summernote form-control @error('short_dec') is-invalid @enderror">{{$edit_data->short_dec}}</textarea>
                @error('short_dec')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-sm-3 mb-3">
              <div class="form-group">
                <label for="status" class="d-block">Banner</label>
                <input type="file" name="banner" class="form-control" >
                @if($edit_data->banner)
                <img src="{{asset($edit_data->banner)}}" class="edit-image border" alt="" />
                @endif
                @error('banner')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
            ...
            <div class="col-sm-3 mb-3">
              <div class="form-group">
                <label for="product_code" class="d-block">Sku</label>
                <input type="text" name="product_code" value="{{ $edit_data->product_code }}">
                @error('topsale')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
