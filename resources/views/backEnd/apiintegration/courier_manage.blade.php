      ...
      <div class="card">
        <div class="card-body">
          <form action="{{route('courierapi.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
            ...
            <div class="col-sm-3 mb-3">
              <div class="form-group">
                <label for="status" class="d-block">Token Generate</label>
              
              <a data-bs-toggle="modal" data-bs-target="#changeStatus" class="btn btn-primary w-100">
                  <i class="fas fa-arrow-circle-up pe-1"></i>Generate
              </a>
...
<div class="modal fade" id="changeStatus" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{route('pathao.token')}}" id="order_sendto_pathao">
          @csrf
      <div class="modal-body">
        <div class="form-group">
            <label for="" class="form-label">Api Key</label>
            <input class="form-control" type="text" name="api_key" value="{{$pathao->api_key}}"/>
        </div>
        <div class="form-group">
            <label for="" class="form-label">Secret Key</label>
            <input class="form-control" type="text" name="secret_key" value="{{$pathao->secret_key}}"/>
        </div>
        <div class="form-group">
