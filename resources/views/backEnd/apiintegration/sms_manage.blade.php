  ...
  <div class="row">
    <div class="col-12">
      <div class="page-title-box">
        ...
        <p>Remagin SMS Balance:{{$smsBalancse}} </p>
      </div>
    </div>
  </div>
  <!-- end page title -->
          ...
          <form action="{{route('smsgeteway.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
            ...
            <div class="col-sm-4">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ $sms->username }}" id="username" required="" />
                @error('username')
