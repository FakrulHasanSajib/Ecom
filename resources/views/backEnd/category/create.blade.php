                ...
                <form action="{{route('categories.store')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('image') is-invalid @enderror" name="image" id="category_image_url" placeholder="Select from Gallery" readonly value="{{ old('image') }}" required>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="summernote form-control @error('meta_description') is-invalid @enderror" name="meta_description" rows="6" id="meta_description">{{ old('meta_description') }}</textarea>
