...
@section('title'.' Author Order')
@section('css')
<link href="{{asset('backEnd')}}/assets/css/order_oage_design.css" rel="stylesheet" type="text/css" />
...
function updateSelectedBanknumbers() {
    const checkedIds = [];
    if (dataTable) {
        // Use DataTable API to get all checked checkboxes across all pages
